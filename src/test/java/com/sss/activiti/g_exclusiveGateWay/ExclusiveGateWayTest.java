package com.sss.activiti.g_exclusiveGateWay;
...
public class ExclusiveGateWayTest {
    ...
    public void deploymentProcessDefinition_InputStream() {
        ...
        Deployment deploy = repositoryService.createDeployment()//创建一个部署对象
                ...
                .addInputStream("sexclusiveGateWay.png", inputStreamPng)
                .deploy();//完成部署
    ...
    public void completeMyPersonalTask() {
        //任务ID
        String taskId = "97505";
        //完成任务的同时,设置流程变量,使用流程变量用来指定完成任务后,下一个连线,对应exclusiveGateWay.bpmn文件中的${money>=500 &&money<=1000}
